...
export default function WhatsAppFAB() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green text-white shadow-lg shadow-green/30 transition-transform duration-200 hover:scale-110 focus-visible:scale-110"
    >
      <svg
        width="28"
        height="28"
